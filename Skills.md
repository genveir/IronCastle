...
- **Hunt.** Tracking and capturing little critters. Mostly used for bugs and small creatures rather than game.
- **Mining.** Extracting good rock, gems and ore from the mountain.
...
Transforming resources or making things by hand.

- **Blacksmithing.** Turning ore into metal, shaping it on an anvil, and making all kinds of metal equipment and tools.
- **Building.** Repairing and building any kind of structure from the ground up.
- **Carpentry.** Treating wood, building furniture, and making all kinds of wooden implements.
- **Cooking.** Combining ingredients into delicious food. If it is tasty, you can make it and bake it.
...
- **Climb.** Moving vertically, whether trees, rooftops or mountains.
- **Jump.** Propelling the body upwards and forwards, and by the book's own joke, jumping to conclusions.
...
- **Barter.** Trading, selling and getting a good deal.
- **Flirt.** Enticing someone with sweet words and good company.
- **Inquire.** Asking questions, being nosy, and getting answers out of people. In moderation.
- **Performance.** Dancing, singing, reciting. There is always a crowd willing to toss coins in a hat.
- **Public Speaking.** Rallying people to a cause and helping them empathize with your point of view.

## Intellectual skills

- **Academics.** Everything learnable from a book. Geography, mathematics, history, unorthodox solutions to complex questions.
- **Admin.** Paperwork, filing, regulations, time management, post, and all the unexciting business of administration.
- **Art.** Expressing creativity. Writing, painting, sculpting, composing.
- **First Aid.** Scraped knees, tummy aches, bad colds, and medical procedures generally. Fights are rare but people still get hurt.
- **Searching.** Finding a needle in a haystack. Scanning a horizon, spotting a bargain, finding lost keys.
- **Science.** Chemistry sets, apparatus, and devices that look more magical than scientific.

Iron Castle note. Science sits awkwardly in a medieval setting. Read it as alchemy, natural philosophy and experiment, or leave it unused.

## Naughty skills

- **Lie.** Hiding your true feelings, keeping information from someone, telling a white lie. Try not to get caught.
- **Mischief.** Pranks, rude jokes, scaring people. The town menace, but a lovable one.
- **Sneak.** Moving unseen and avoiding people you would rather not run into.
...
- **Rainbow Magic.** Manipulating the refraction of light to create illusions and mirages. Requires concentration, and requires an existing light source, since it does not create light.
- **Soupification.** Turning boring things into soup and tasty things into very tasty soup. Slow, ritual, time consuming, and worth it.
- **Sun Magic.** Absorbing sunlight to empower the body for a short time. Run faster, jump higher. Does not create light.
- **Transmutation.** Changing the physical properties of a person's body, including your own. Nose, hair, eye colour, and helping a friend transition. Needs time and the right materials.
- **Weather Magic.** Manipulating air, moisture and atmospheric pressure. Clearing skies, summoning rain and thunder.

Magic is governed by Shadow. Try Your Best!! rolls made with magic use +shadow.

Iron Castle note. Magic exists in Iron Castle but keeps to the deep woods below the bluff. It repels civilisation and civilisation repels it, so magic is uncommon inside the walls, not absent. A character can still learn a magic school. Nothing forbids it.

## Custom skills

Players may invent skills. A good custom skill is specific enough not to apply to everything, but broad enough to come up regularly. The book's examples are Nursing, Surfing, Pastry Chef, Psychic Power: Telekinesis, and Shapeshift: Bear. Write a short description with pros and cons.